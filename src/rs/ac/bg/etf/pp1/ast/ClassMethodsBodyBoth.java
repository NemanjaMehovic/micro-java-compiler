...
public class ClassMethodsBodyBoth extends ClassMethodsBody {

    private ConstructorDecl ConstructorDecl;
    private MethodDeclList MethodDeclList;

    public ClassMethodsBodyBoth (ConstructorDecl ConstructorDecl, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassMethodsBodyBoth(\n");
