...
public class ClassMethodsBodyOnlyConstructor extends ClassMethodsBody {

    private ConstructorDecl ConstructorDecl;

    public ClassMethodsBodyOnlyConstructor (ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassMethodsBodyOnlyConstructor(\n");
