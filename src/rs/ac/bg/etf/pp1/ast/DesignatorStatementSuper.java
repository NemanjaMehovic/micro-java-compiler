...
public class DesignatorStatementSuper extends DesignatorStatement {

    private MakeNewActParmsListSuper MakeNewActParmsListSuper;
    private ActParsList ActParsList;

    public DesignatorStatementSuper (MakeNewActParmsListSuper MakeNewActParmsListSuper, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementSuper(\n");
