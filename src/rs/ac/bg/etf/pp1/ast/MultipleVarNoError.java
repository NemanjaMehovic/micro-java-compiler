...
public class MultipleVarNoError extends VarListNoError {

    private VarListNoError VarListNoError;
    private VarTypeNoError VarTypeNoError;

    public MultipleVarNoError (VarListNoError VarListNoError, VarTypeNoError VarTypeNoError) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleVarNoError(\n");
